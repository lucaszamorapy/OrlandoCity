        ...
        <div class="row">
            ...
            <div class="col-md-3" ng-repeat="produto in buscados"> 
                <div class="box-produto-info">
                    <a href="#">
                        <img src="img/produtos/{{produto.foto_principal}}" alt="{{produto.nome_prod_longo}}" class="produto-img"></a>
...
angular.module("shop", []).controller("destaque-controller", function($scope, $http){
    ...
    var initEstrelas = function(){
        ...
        $('.estrelas').each(function(){
            ...
            $(this).raty({
                starHalf    : 'lib/raty/raty-master/lib/images/star-half.png',                                // The name of the half star image.
                starOff     : 'lib/raty/raty-master/lib/images/star-off.png',                                 // Name of the star image off.
                starOn      : 'lib/raty/raty-master/lib/images/star-on.png',
